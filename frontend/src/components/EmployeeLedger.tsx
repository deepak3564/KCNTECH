  ...
  return (
    <section className="admin-panel">
      ...
      <div className="ledger-row">
        ...
        <label>{t("From")}<input type="date" value={fromDate} onChange={(e) => setFromDate(e.target.value)} /></label>
        <label>{t("To")}<input type="date" value={toDate} onChange={(e) => setToDate(e.target.value)} /></label>
